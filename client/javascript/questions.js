document.addEventListener('DOMContentLoaded', function () {
    ...
    fetch(`https://learnify-8k73.onrender.comapi/obtenerPregunta?categoria=${categoria}&userUUID=${userUUID}`)
    ...
    function handleAnswer(card, respuestaSeleccionada, preguntaId, respuestaCorrecta) {
        ...
        setTimeout(() => {
            fetch('https://learnify-8k73.onrender.comapi/registrarRespuesta', {
                method: 'POST',
                headers: {
